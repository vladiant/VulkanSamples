...
// https://github.com/SaschaWillems/Vulkan/blob/b9f0ac91d2adccc3055a904d3a8f6553b10ff6cd/examples/screenshot/screenshot.cpp
...
class HelloTriangleApplication {
 ...
 private:
  ...
  void saveScreenshot(const char* filename) {
    ...
    if (vkCreateImage(device, &imageCreateCI, nullptr, &dstImage) !=
        VK_SUCCESS) {
      throw std::runtime_error("failed to create image!");
    }
    ...
    if (!supportsBlit) {
      ...
      colorSwizzle = (std::find(formatsBGR.begin(), formatsBGR.end(),
                                swapChainImageFormat) != formatsBGR.end());
    }
