...
VkDebugReportCallbackEXT initDebug(VkInstance instance,
                                   const VkDebugReportFlagsEXT debugAmount);
...
VKAPI_ATTR VkBool32 VKAPI_CALL genericDebugCallback(
  ...
  string report = to_string(objType) + to_string(srcObject) + ": " +
                  to_string(msgCode) + ", " + pLayerPrefix + ", " + pMsg;
  ;
...
PFN_vkCreateDebugReportCallbackEXT fpCreateDebugReportCallbackEXT =
    &vkCreateDebugReportCallbackEXT_loader;

VKAPI_ATTR VkResult VKAPI_CALL vkCreateDebugReportCallbackEXT(
    VkInstance instance, const VkDebugReportCallbackCreateInfoEXT* pCreateInfo,
    const VkAllocationCallbacks* pAllocator,
    VkDebugReportCallbackEXT* pCallback) {
  return fpCreateDebugReportCallbackEXT(instance, pCreateInfo, pAllocator,
                                        pCallback);
}
...
PFN_vkDestroyDebugReportCallbackEXT fpDestroyDebugReportCallbackEXT =
    &vkDestroyDebugReportCallbackEXT_loader;
...
PFN_vkDebugReportMessageEXT fpDebugReportMessageEXT =
    &vkDebugReportMessageEXT_loader;

VKAPI_ATTR void VKAPI_CALL vkDebugReportMessageEXT(
    VkInstance instance, VkDebugReportFlagsEXT flags,
    VkDebugReportObjectTypeEXT objectType, uint64_t object, size_t location,
    int32_t messageCode, const char* pLayerPrefix, const char* pMessage) {
  fpDebugReportMessageEXT(instance, flags, objectType, object, location,
                          messageCode, pLayerPrefix, pMessage);
}
...
VkDebugReportCallbackEXT initDebug(VkInstance instance,
  ...
  VkResult errorCode = vkCreateDebugReportCallbackEXT(
      instance, &debugCreateInfo, nullptr, &debug);
